...
CORE_DATASETS: tuple[ExportDataset, ...] = (
    ...
    ExportDataset(
        ...
        result_files=(
            ...
            "data/ml/anchors/opening_gap_strict_context_leaderboard.csv",
            "data/ml/anchors/opening_gap_strict_context_leaderboard.parquet",
            "data/ml/anchors/opening_gap_strict_context_walk_forward_summary.csv",
            "data/ml/anchors/opening_gap_strict_context_walk_forward_summary.parquet",
            "data/ml/anchors/opening_gap_strict_context_walk_forward_folds.csv",
            "data/ml/anchors/opening_gap_strict_context_walk_forward_folds.parquet",
