...
CORE_DATASETS: tuple[ExportDataset, ...] = (
    ...
    ExportDataset(
        name="fvg_xctx_fvggeom_obgeom",
        description="FVG anchor rows with cross-concept context, FVG geometry, and state-aware nearby order-block geometry.",
        matrix="data/ml/anchors/fvg_snapshots_xctx_fvggeom_obgeom.parquet",
        schema="data/ml/anchors/fvg_snapshots_xctx_fvggeom_obgeom.schema.json",
        audit_doc="docs/ML_SNAPSHOT_AUDIT_FVG_FVGGEOM_OBGEOM.md",
        leaderboard_doc="docs/ML_SNAPSHOT_LEADERBOARD_FVG_FVGGEOM_OBGEOM.md",
        walk_forward_doc="docs/ML_SNAPSHOT_WALK_FORWARD_FVG_FVGGEOM_OBGEOM.md",
        result_files=(
            "data/ml/context/fvg_ob_geometry_context.parquet",
        ),
    ),
    ExportDataset(
        name="fvg_xctx_fvggeom_obgeom_strict",
        description="FVG final context matrix with stricter tap/fill/reject/continuation labels.",
        ...
        audit_doc="docs/ML_SNAPSHOT_AUDIT_FVG_STRICT_CONTEXT.md",
        leaderboard_doc="docs/ML_SNAPSHOT_LEADERBOARD_FVG_STRICT_CONTEXT.md",
        walk_forward_doc="docs/ML_SNAPSHOT_WALK_FORWARD_FVG_STRICT_CONTEXT.md",
        result_files=(
            "data/ml/anchors/fvg_strict_label_stats.csv",
            "data/ml/anchors/fvg_snapshot_leaderboard_strict_context.csv",
            "data/ml/anchors/fvg_snapshot_leaderboard_strict_context.parquet",
            "data/ml/anchors/fvg_walk_forward_strict_context_summary.csv",
            "data/ml/anchors/fvg_walk_forward_strict_context_summary.parquet",
            "data/ml/anchors/fvg_walk_forward_strict_context_folds.csv",
            "data/ml/anchors/fvg_walk_forward_strict_context_folds.parquet",
            "docs/ML_FVG_STRICT_LABELS.md",
            "docs/ML_FVG_STRICT_LABEL_RESULTS.md",
        ),
    ),
    ExportDataset(
    ...
    ExportDataset(
        name="sweep_xctx_fvggeom_obgeom",
        description="Liquidity sweep anchor rows with cross-concept context, FVG geometry, and state-aware nearby order-block geometry.",
        ...
        audit_doc="docs/ML_SNAPSHOT_AUDIT_SWEEP_FVGGEOM_OBGEOM.md",
        ...
        result_files=(
            ...
            "data/ml/anchors/sweep_walk_forward_fvggeom_obgeom_summary.csv",
            "data/ml/anchors/sweep_walk_forward_fvggeom_obgeom_summary.parquet",
            "data/ml/anchors/sweep_walk_forward_fvggeom_obgeom_folds.csv",
            "data/ml/anchors/sweep_walk_forward_fvggeom_obgeom_folds.parquet",
        ),
    ),
    ExportDataset(
    ...
    ExportDataset(
        ...
        leaderboard_doc="docs/ML_SNAPSHOT_LEADERBOARD_SMT_FVGGEOM_OBGEOM_LIQGEOM_REGIME.md",
        walk_forward_doc="docs/ML_SNAPSHOT_WALK_FORWARD_SMT_FVGGEOM_OBGEOM_LIQGEOM_REGIME.md",
        result_files=(
            ...
            "data/ml/anchors/smt_previous_day_snapshot_leaderboard_xctx_fvggeom_obgeom_liqgeom_regime.csv",
            "data/ml/anchors/smt_previous_day_snapshot_leaderboard_xctx_fvggeom_obgeom_liqgeom_regime.parquet",
            "data/ml/anchors/smt_previous_day_walk_forward_fvggeom_obgeom_liqgeom_regime_summary.csv",
            "data/ml/anchors/smt_previous_day_walk_forward_fvggeom_obgeom_liqgeom_regime_summary.parquet",
            "data/ml/anchors/smt_previous_day_walk_forward_fvggeom_obgeom_liqgeom_regime_folds.csv",
            "data/ml/anchors/smt_previous_day_walk_forward_fvggeom_obgeom_liqgeom_regime_folds.parquet",
            "data/ml/anchors/smt_previous_day_walk_forward_at_fire_thesis_context_layers_summary.csv",
            "data/ml/anchors/smt_previous_day_walk_forward_at_fire_thesis_context_layers_summary.parquet",
            "data/ml/anchors/smt_previous_day_walk_forward_at_fire_thesis_context_layers_folds.csv",
            "data/ml/anchors/smt_previous_day_walk_forward_at_fire_thesis_context_layers_folds.parquet",
            ...
            "docs/ML_SNAPSHOT_WALK_FORWARD_SMT_AT_FIRE_THESIS_CONTEXT_LAYERS.md",
        ),
    ),
    ExportDataset(
        name="vp_v2_xctx",
    ...
    ExportDataset(
        ...
        result_files=(
            "backend/app/research/features/ogap/README.md",
            "backend/app/research/features/ogap/stats.md",
            "data/ml/features/ogap.parquet",
            "data/ml/context/opening_gap_cross_concept_context.parquet",
            "data/ml/context/opening_gap_opening_gap_context.parquet",
    ...
    ExportDataset(
        name="opening_gap_xctx_gapctx_obgeom_liqgeom_regime",
        description="NDOG/NWOG anchor rows with cross-concept context, prior opening-gap memory, OB geometry, swing/equal-level liquidity geometry, and completed-interval regime context.",
        ...
        audit_doc="docs/ML_SNAPSHOT_AUDIT_OPENING_GAP_XCTX_GAPCTX_OBGEOM_LIQGEOM_REGIME.md",
        leaderboard_doc="docs/ML_SNAPSHOT_LEADERBOARD_OPENING_GAP_XCTX_GAPCTX_OBGEOM_LIQGEOM_REGIME.md",
        walk_forward_doc="docs/ML_SNAPSHOT_WALK_FORWARD_OPENING_GAP_XCTX_GAPCTX_OBGEOM_LIQGEOM_REGIME.md",
        result_files=(
            "data/ml/anchors/opening_gap_snapshots_xctx_gapctx_obgeom_liqgeom.parquet",
            "data/ml/anchors/opening_gap_snapshots_xctx_gapctx_obgeom_liqgeom.schema.json",
            "data/ml/anchors/opening_gap_snapshot_leaderboard_xctx_gapctx_obgeom_liqgeom_regime.csv",
            "data/ml/anchors/opening_gap_snapshot_leaderboard_xctx_gapctx_obgeom_liqgeom_regime.parquet",
            "data/ml/anchors/opening_gap_walk_forward_xctx_gapctx_obgeom_liqgeom_regime_summary.csv",
            "data/ml/anchors/opening_gap_walk_forward_xctx_gapctx_obgeom_liqgeom_regime_summary.parquet",
            "data/ml/anchors/opening_gap_walk_forward_xctx_gapctx_obgeom_liqgeom_regime_folds.csv",
            "data/ml/anchors/opening_gap_walk_forward_xctx_gapctx_obgeom_liqgeom_regime_folds.parquet",
            "data/ml/context/opening_gap_liquidity_level_context.parquet",
            "data/ml/context/opening_gap_regime_context.parquet",
            "docs/ML_OPENING_GAP_CONTEXT_LAYER_RESULTS.md",
        ),
    ),
    ExportDataset(
        name="opening_gap_xctx_gapctx_obgeom_liqgeom_regime_strict",
        description="Opening-gap final context matrix with stricter composite reaction labels for fill/reject/fail/continuation behavior.",
        ...
        audit_doc="docs/ML_SNAPSHOT_AUDIT_OPENING_GAP_STRICT_CONTEXT.md",
        leaderboard_doc="docs/ML_SNAPSHOT_LEADERBOARD_OPENING_GAP_STRICT_CONTEXT.md",
        walk_forward_doc="docs/ML_SNAPSHOT_WALK_FORWARD_OPENING_GAP_STRICT_CONTEXT.md",
        result_files=(
            "data/ml/anchors/opening_gap_strict_label_stats.csv",
            "data/ml/anchors/opening_gap_snapshot_leaderboard_strict_context.csv",
            "data/ml/anchors/opening_gap_snapshot_leaderboard_strict_context.parquet",
            "data/ml/anchors/opening_gap_walk_forward_strict_context_summary.csv",
            "data/ml/anchors/opening_gap_walk_forward_strict_context_summary.parquet",
            "data/ml/anchors/opening_gap_walk_forward_strict_context_folds.csv",
            "data/ml/anchors/opening_gap_walk_forward_strict_context_folds.parquet",
            "docs/ML_OPENING_GAP_STRICT_LABELS.md",
            "docs/ML_OPENING_GAP_STRICT_LABEL_RESULTS.md",
        ),
    ),
    ExportDataset(
        name="itr_xctx",
    ...
    ExportDataset(
        ...
        leaderboard_doc="docs/ML_SNAPSHOT_LEADERBOARD_SWEEP_FVGGEOM_OBGEOM_LIQGEOM_REGIME.md",
        walk_forward_doc="docs/ML_SNAPSHOT_WALK_FORWARD_SWEEP_FVGGEOM_OBGEOM_LIQGEOM_REGIME.md",
        result_files=(
            ...
            "data/ml/anchors/sweep_snapshot_leaderboard_xctx_fvggeom_obgeom_liqgeom_regime.csv",
            "data/ml/anchors/sweep_snapshot_leaderboard_xctx_fvggeom_obgeom_liqgeom_regime.parquet",
            "data/ml/anchors/sweep_walk_forward_fvggeom_obgeom_liqgeom_regime_summary.csv",
            "data/ml/anchors/sweep_walk_forward_fvggeom_obgeom_liqgeom_regime_summary.parquet",
            "data/ml/anchors/sweep_walk_forward_fvggeom_obgeom_liqgeom_regime_folds.csv",
            "data/ml/anchors/sweep_walk_forward_fvggeom_obgeom_liqgeom_regime_folds.parquet",
    ...
    ExportDataset(
        name="sweep_xctx_fvggeom_obgeom_liqgeom_regime_strict",
        description="Liquidity sweep final context matrix with stricter true-clock-time recovery/rejection/continuation labels.",
        ...
        audit_doc="docs/ML_SNAPSHOT_AUDIT_SWEEP_STRICT_CONTEXT.md",
        leaderboard_doc="docs/ML_SNAPSHOT_LEADERBOARD_SWEEP_STRICT_CONTEXT.md",
        walk_forward_doc="docs/ML_SNAPSHOT_WALK_FORWARD_SWEEP_STRICT_CONTEXT.md",
        result_files=(
            "data/ml/anchors/sweep_strict_label_stats.csv",
            "data/ml/anchors/sweep_snapshot_leaderboard_strict_context.csv",
            "data/ml/anchors/sweep_snapshot_leaderboard_strict_context.parquet",
            "data/ml/anchors/sweep_walk_forward_strict_context_summary.csv",
            "data/ml/anchors/sweep_walk_forward_strict_context_summary.parquet",
            "data/ml/anchors/sweep_walk_forward_strict_context_folds.csv",
            "data/ml/anchors/sweep_walk_forward_strict_context_folds.parquet",
            "docs/ML_SWEEP_STRICT_LABELS.md",
            "docs/ML_SWEEP_STRICT_LABEL_RESULTS.md",
        ),
    ),
    ExportDataset(
        name="swing_strict",
        description="Swing-pivot anchor rows with stricter true-clock-time hold, break, partial-test, immediate-fail, and double-test reaction labels.",
        matrix="data/ml/anchors/swing_snapshots_strict.parquet",
        schema="data/ml/anchors/swing_snapshots_strict.schema.json",
        audit_doc="docs/ML_SNAPSHOT_AUDIT_SWING_STRICT_CONTEXT.md",
        leaderboard_doc="docs/ML_SNAPSHOT_LEADERBOARD_SWING_STRICT_CONTEXT.md",
        walk_forward_doc="docs/ML_SNAPSHOT_WALK_FORWARD_SWING_STRICT_CONTEXT.md",
        result_files=(
            "data/ml/anchors/swing_strict_label_stats.csv",
            "data/ml/anchors/swing_snapshot_leaderboard_strict_context.csv",
            "data/ml/anchors/swing_snapshot_leaderboard_strict_context.parquet",
            "data/ml/anchors/swing_walk_forward_strict_context_summary.csv",
            "data/ml/anchors/swing_walk_forward_strict_context_summary.parquet",
            "data/ml/anchors/swing_walk_forward_strict_context_folds.csv",
            "data/ml/anchors/swing_walk_forward_strict_context_folds.parquet",
            "docs/ML_SWING_STRICT_LABELS.md",
            "docs/ML_SWING_STRICT_LABEL_RESULTS.md",
        ),
    ),
    ExportDataset(
        name="ob_xctx_strict",
        description="Order-block anchor rows with cross-concept context and stricter true-clock-time respect, break, fail, and recovery labels.",
        matrix="data/ml/anchors/ob_snapshots_xctx_strict.parquet",
        schema="data/ml/anchors/ob_snapshots_xctx_strict.schema.json",
        audit_doc="docs/ML_SNAPSHOT_AUDIT_OB_STRICT_CONTEXT.md",
        leaderboard_doc="docs/ML_SNAPSHOT_LEADERBOARD_OB_STRICT_CONTEXT.md",
        walk_forward_doc="docs/ML_SNAPSHOT_WALK_FORWARD_OB_STRICT_CONTEXT.md",
        result_files=(
            "data/ml/anchors/ob_strict_label_stats.csv",
            "data/ml/anchors/ob_snapshot_leaderboard_strict_context.csv",
            "data/ml/anchors/ob_snapshot_leaderboard_strict_context.parquet",
            "data/ml/anchors/ob_walk_forward_strict_context_summary.csv",
            "data/ml/anchors/ob_walk_forward_strict_context_summary.parquet",
            "data/ml/anchors/ob_walk_forward_strict_context_folds.csv",
            "data/ml/anchors/ob_walk_forward_strict_context_folds.parquet",
            "docs/ML_OB_STRICT_LABELS.md",
            "docs/ML_OB_STRICT_LABEL_RESULTS.md",
        ),
    ),
    ExportDataset(
        name="macro_xctx",
        ...
        result_files=(
            ...
            "docs/ML_MACRO_EVENT_TYPE_BREAKDOWN.md",
            "data/ml/anchors/macro_event_type_breakdown.csv",
            "data/ml/anchors/macro_event_type_breakdown.parquet",
            "data/ml/anchors/macro_event_type_model_leaderboard.csv",
            "data/ml/anchors/macro_event_type_model_leaderboard.parquet",
            "data/ml/anchors/macro_event_type_walk_forward_summary.csv",
            "data/ml/anchors/macro_event_type_walk_forward_summary.parquet",
            "data/ml/anchors/macro_event_type_walk_forward_folds.csv",
            "data/ml/anchors/macro_event_type_walk_forward_folds.parquet",
        ),
    ),
)
...
CORE_DOCS: tuple[str, ...] = (
    ...
    "docs/ML_OB_STRICT_LABELS.md",
    "docs/ML_OB_STRICT_LABEL_RESULTS.md",
    "docs/ML_UNIVERSAL_REACTION_LABELS.md",
