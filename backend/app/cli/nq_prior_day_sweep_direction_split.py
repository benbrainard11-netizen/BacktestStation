"""Run direction-split diagnostics for prior-day sweep strategy validation."""
...
from app.research.nq_prior_day_sweep_direction_split import (
    ...
    write_prior_day_sweep_direction_split_outputs,
)
...
def main(argv: list[str] | None = None) -> int:
    ...
    write_prior_day_sweep_direction_split_outputs(result, args.output_dir)
