"""Run descriptive diagnostics for prior-day low sweep winner/loss differences."""
...
from app.research.nq_prior_day_low_sweep_descriptive import (
    ...
    write_prior_day_low_sweep_descriptive_outputs,
)
...
def main(argv: list[str] | None = None) -> int:
    ...
    write_prior_day_low_sweep_descriptive_outputs(result, args.output_dir)
