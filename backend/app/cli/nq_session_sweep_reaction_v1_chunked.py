"""Run NQ Session Sweep Reaction V1 with per-session MBP-1 loading."""
...
from app.research.nq_session_sweep_reaction_v1_chunked import run_chunked_backtest
