...
| `itr` | [guide](itr/README.md) | [stats](itr/stats.md) | ITR - Interval True Range | 190,192 | 143 | 100.0% | 0.818 | `label.next_interval.range_expanded_2x_interval` | Good standalone signal. |
...
| `swing` | [guide](swing/README.md) | [stats](swing/stats.md) | Swing Pivot | 345,702 | 73 | 100.0% | 0.805 | `label.strict.next_60m.pivot_broken_through_continuation` | Good standalone signal. |
| `tp` | [guide](tp/README.md) | [stats](tp/stats.md) | Time Profile | 105,819 | 84 | 100.0% | 0.766 | `label.next_period.took_parent_high` | Good standalone signal. |
| `vp` | [guide](vp/README.md) | [stats](vp/stats.md) | Volume Profile | 183,662 | 212 | 100.0% | 0.961 | `label.vwap_1sd_low_touch.wicked_above` | Strong ranking signal, but the best label is very imbalanced. Keep it, but design harder labels. |
