...
| `macro` | [guide](macro/README.md) | [stats](macro/stats.md) | Scheduled Macro Events | 18,414 | 276 | 100.0% | 0.927 | `label.next_15m.range_expanded_2x_pre_60m` | Strong ranking signal, but the best label is very imbalanced. Keep it, but design harder labels. |
