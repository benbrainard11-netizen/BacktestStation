...
| `fvg` | [guide](fvg/README.md) | [stats](fvg/stats.md) | FVG Formation | 209,339 | 124 | 100.0% | 0.773 | `label.mitigation.fully_filled` | Good standalone signal. |
...
| `sweep` | [guide](sweep/README.md) | [stats](sweep/stats.md) | Liquidity Sweep | 52,946 | 86 | 100.0% | 0.888 | `label.ob_confirmation.did_confirm` | Strong ranking signal, but the best label is very imbalanced. Keep it, but design harder labels. |
