...
_Generated `2026-05-12T02:14:03+00:00` by `backend/scripts/refresh_dashboards.py`._
...
|---|---|---|---|---|---|---|---|
| ob | all | `label.level_tags.open.wick_tapped` | 8,764 | 95.3% | 0.872 | 100.0% | high base rate |
| ob | bearish | `label.level_tags.open.wick_tapped` | 4,679 | 96.2% | 0.868 | 100.0% | high base rate |
| ob | bullish | `label.level_tags.open.wick_tapped` | 4,085 | 94.2% | 0.858 | 100.0% | high base rate |
| ob | bearish | `label.level_tags.q25.wick_tapped` | 4,679 | 95.6% | 0.858 | 99.8% | high base rate |
| ob | all | `label.level_tags.q25.wick_tapped` | 8,764 | 94.5% | 0.850 | 99.4% | high base rate |
| ob | bearish | `label.level_tags.q50.wick_tapped` | 4,679 | 94.9% | 0.841 | 100.0% | high base rate |
| ob | bullish | `label.level_tags.q25.wick_tapped` | 4,085 | 93.2% | 0.830 | 99.5% | high base rate |
| ob | all | `label.level_tags.q50.wick_tapped` | 8,764 | 93.3% | 0.817 | 99.9% | high base rate |
| ob | bearish | `label.level_tags.q75.wick_tapped` | 4,679 | 94.0% | 0.808 | 99.8% | high base rate |
| ob | bullish | `label.level_tags.q50.wick_tapped` | 4,085 | 91.6% | 0.791 | 99.0% | high base rate |
