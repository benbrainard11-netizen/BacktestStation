...
_Generated 2026-05-18T19:05:01.930281Z_

Coverage: 14 features × 23 symbols = 317 profile rows.

Total events analyzed: 4,158,076
...
|---|---|---:|---:|---:|---:|
| 1 | `swing_pivot` | 4 | 3.6772 | nan | 1.6585 |
| 2 | `liquidity_sweep` | 4 | 0.999 | nan | 0.984 |
| 3 | `displacement_candle` | 4 | 0.997 | nan | 1.0145 |

### energy

| Rank | Feature | n_symbols | fwd10 ratio (mean) | fwd10 hit (mean) | fwd50 ratio (mean) |
|---|---|---:|---:|---:|---:|
| 1 | `swing_pivot` | 5 | 3.6714 | nan | 1.6144 |
| 2 | `displacement_candle` | 5 | 1.0642 | nan | 1.0488 |
| 3 | `fvg_formation` | 5 | 1.0172 | 0.489 | 1.0172 |

### fx

| Rank | Feature | n_symbols | fwd10 ratio (mean) | fwd10 hit (mean) | fwd50 ratio (mean) |
|---|---|---:|---:|---:|---:|
| 1 | `swing_pivot` | 7 | 4.6853 | nan | 1.8091 |
| 2 | `liquidity_sweep` | 7 | 1.0237 | nan | 1.0161 |
...
| Rank | Feature | n_symbols | fwd10 ratio (mean) | fwd10 hit (mean) | fwd50 ratio (mean) |
|---|---|---:|---:|---:|---:|
| 1 | `swing_pivot` | 3 | 4.294 | nan | 1.814 |
| 2 | `liquidity_sweep` | 3 | 1.0087 | nan | 1.0027 |
| 3 | `displacement_candle` | 3 | 1.001 | nan | 1.0067 |

### index

| Rank | Feature | n_symbols | fwd10 ratio (mean) | fwd10 hit (mean) | fwd50 ratio (mean) |
|---|---|---:|---:|---:|---:|
| 1 | `swing_pivot` | 4 | 3.334 | nan | 1.5962 |
| 2 | `liquidity_sweep` | 4 | 1.0215 | nan | 1.019 |
...
|---|---|---|---:|---:|---:|---:|---:|
| 1 | CL.c.0 | energy | 9,266 | 1029.6 | 1.101 | nan | 1.07 |
| 2 | HO.c.0 | energy | 9,444 | 1049.3 | 1.087 | nan | 1.094 |
| 3 | BZ.c.0 | energy | 9,291 | 1032.3 | 1.068 | nan | 1.053 |
| 4 | RB.c.0 | energy | 9,265 | 1029.4 | 1.064 | nan | 1.023 |
| 5 | ZS.c.0 | grain | 6,183 | 687.0 | 1.041 | nan | 1.037 |
...
| # | Symbol | Class | Events | per_yr | fwd10 ratio | fwd10 hit | fwd50 ratio |
|---|---|---|---:|---:|---:|---:|---:|
| 1 | 6A.c.0 | fx | 10,336 | 1148.4 | 1.08 | nan | 1.04 |
| 2 | 6C.c.0 | fx | 9,177 | 1019.7 | 1.055 | nan | 1.037 |
| 3 | ZW.c.0 | grain | 9,138 | 1015.3 | 1.039 | nan | 1.015 |
| 4 | ES.c.0 | index | 10,965 | 1218.3 | 1.032 | nan | 1.025 |
| 5 | NQ.c.0 | index | 10,980 | 1220.0 | 1.03 | nan | 1.023 |
...
| # | Symbol | Class | Events | per_yr | fwd10 ratio | fwd10 hit | fwd50 ratio |
|---|---|---|---:|---:|---:|---:|---:|
| 1 | 6C.c.0 | fx | 9,777 | 1086.3 | 5.724 | nan | 2.038 |
| 2 | 6B.c.0 | fx | 12,595 | 1399.4 | 5.554 | nan | 1.902 |
| 3 | 6A.c.0 | fx | 12,499 | 1388.8 | 5.505 | nan | 1.932 |
| 4 | 6J.c.0 | fx | 13,580 | 1508.9 | 4.865 | nan | 1.827 |
| 5 | ZS.c.0 | grain | 11,193 | 1243.7 | 4.395 | nan | 1.817 |
