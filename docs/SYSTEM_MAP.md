...
| 247 execution queue Q6-Q8 (Trials/Candidates/Live Monitor) | 247 | Q6-Q7 merged; Q8 Live Monitor in branch |
...
- `frontend/app/live-monitor/` - Live Monitor empty-state screen; Q8 frontend build
