...
_Generated `2026-05-17T22:59:58.214936+00:00`._
...
| `anchor.` | anchor_metadata | 60 | 405 | Anchor event identifiers and raw event-time metadata. |
| `asof.` | snapshot_metadata | 60 | 294 | Snapshot identity, cutoff timestamp, and label window timestamps. |
...
| `disp.` | displacement_event_time | 2 | 58 | Filtered displacement-candle event-time fields knowable at detector fire. |
...
| `fvg.` | fvg_event_time | 6 | 164 | Filtered FVG event-time fields knowable at detector fire. |
...
| `label.` | forward_label | 58 | 7,441 | Forward prediction targets. These must never be fed back as model features. |
...
| `ob.` | order_block_event_time | 4 | 156 | Filtered order-block event-time fields knowable at detector fire. |
...
| `psp.` | psp_event_time | 2 | 72 | Filtered PSP event-time fields knowable at detector fire. |
...
| `smtstate.` | active_smt_state_context | 5 | 425 | Active forming/confirmed SMT state joined as-of the snapshot cutoff. |
| `sweep.` | sweep_event_time | 8 | 172 | Filtered liquidity-sweep event-time fields knowable at detector fire. |
...
| `ts.` | time | 58 | 232 | Calendar features computed from the snapshot timestamp. |
...
| `xd.` | prior_cross_detector | 76 | 1,067 | Coarse Phase 1 flags for prior detector events before anchor fire. |
...
| `ob_snapshots_smtstate` | `ob` | 198,069 | 376 | 138 | 226 |
...
| `psp_snapshots_smtstate` | `psp` | 77,933 | 186 | 141 | 33 |
...
| `sweep_snapshots_smtstate` | `sweep` | 237,569 | 158 | 119 | 27 |
