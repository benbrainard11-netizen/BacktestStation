...
function ColumnHeader({
  ...
  return (
    <header className="mb-4 flex items-baseline gap-3 border-b border-zinc-100/30 pb-2">
      <span className="text-[10px] tabular-nums text-zinc-600">{number}</span>
      <h3 className="text-xs uppercase tracking-[0.5em] text-zinc-300">
        {title}
      </h3>
    </header>
  );
  ...
  const toneClass =
    tone === "positive"
      ...
      : tone === "negative"
        ...
        : "text-zinc-100";
  return (
    <div className="flex items-baseline justify-between gap-3 border-b border-zinc-900 py-1.5 last:border-b-0">
  ...
  return (
    <section className="grid grid-cols-1 gap-10 lg:grid-cols-3 lg:gap-14">
      ...
      <div>
        ...
        <p className="mt-3 text-[10px] uppercase tracking-[0.32em] text-zinc-600">
