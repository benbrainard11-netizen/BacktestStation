  ...
  const toneClass =
    tone === "positive"
      ...
      : tone === "negative"
        ...
        : "text-zinc-100";
  return (
    <div className="flex items-baseline justify-between gap-3 border-b border-zinc-800 py-2">
    ...
    <section className="grid grid-cols-1 gap-10 lg:grid-cols-12 lg:gap-12">
      <div className="flex flex-col gap-6 lg:col-span-5">
        <div className="flex flex-col gap-1.5">
          ...
          <h1 className="text-3xl font-light leading-tight tracking-tight text-zinc-50 sm:text-4xl">
            {firm.firm_name}
      ...
      <div className="relative flex flex-col justify-end lg:col-span-7">
        <span className="absolute -top-4 left-0 text-[10px] uppercase tracking-[0.5em] text-zinc-600">
        ...
        <p className="mt-4 flex flex-wrap items-baseline gap-x-4 gap-y-1 font-light text-zinc-400">
