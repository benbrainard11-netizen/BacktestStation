...
export default function RiskSweepTable({ rows }: RiskSweepTableProps) {
 ...
 <th className="whitespace-nowrap py-2 pr-3 text-right">Fail</th>
 ...
 <th className="whitespace-nowrap py-2 pr-3">Main fail</th>
 </tr>
 </thead>
 <tbody>
 {rows.map((row) => {
 ...
 {isBestEv || isBestPass ? (
 <span className="ml-2 border border-pos/30 bg-pos/10 px-1 py-[1px] text-[9px] text-pos">
