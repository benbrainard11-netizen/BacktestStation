...
export default function CommandPalette() {
 ...
 >
 <div className="panel-enter mt-32 w-full max-w-lg overflow-hidden rounded-md border border-border-strong bg-surface ">
 ...
 />
 <kbd className="hidden h-5 items-center rounded-sm border border-border-strong bg-surface-alt px-1.5 tabular-nums text-[9px] text-text-dim sm:flex">
 esc
 </kbd>
 </div>
 ...
 >
 {filtered.length === 0 ? (
 <li className="px-3 py-6 text-center tabular-nums text-[11px] text-text-mute">
 No matches
 </li>
 ) : (
 filtered.map((item, i) => {
 ...
 : "text-text-dim hover:bg-surface-alt",
 )}
 >
 <Icon
 className={cn(
 "h-3.5 w-3.5 shrink-0",
 isActive ? "text-pos" : "text-text-mute",
 )}
 strokeWidth={1.75}
 aria-hidden="true"
 />
 ...
 {isActive ? (
 <CornerDownLeft
 className="h-3 w-3 text-text-mute"
 strokeWidth={1.75}
 aria-hidden="true"
 />
 ) : (
 ...
 <div className="flex items-center justify-between gap-3 border-t border-border px-3 py-1.5 tabular-nums text-[9px] text-text-mute">
 <div className="flex items-center gap-3">
 <span>
 <kbd className="rounded-sm border border-border-strong bg-surface-alt px-1 text-text-dim">
 ↑
 </kbd>
 <kbd className="ml-1 rounded-sm border border-border-strong bg-surface-alt px-1 text-text-dim">
 ↓
 </kbd>{" "}
 navigate
 </span>
