...
export default function OverlaidEquityChart({ a, b }: OverlaidEquityChartProps) {
 ...
 return <p className="tabular-nums text-xs text-text-mute">No equity data.</p>;
 }
 ...
 <div className="flex items-center gap-4 tabular-nums text-[11px] text-text-dim">
 ...
 <div className="pointer-events-none absolute inset-0 flex flex-col justify-between p-2 tabular-nums text-[10px] text-text-mute">
