...
export default function OverlaidRHistogram({ a, b }: OverlaidRHistogramProps) {
 ...
 return <p className="tabular-nums text-xs text-text-mute">No r_multiple values.</p>;
 }
 ...
 <div className="flex flex-wrap items-center gap-4 tabular-nums text-[11px] text-text-dim">
