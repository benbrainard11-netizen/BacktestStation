...
export default function EquityChart({ points }: EquityChartProps) {
  if (points.length === 0) {
    return (
      <p className="font-mono text-xs text-zinc-500">No equity points.</p>
    );
  }
  ...
  return (
    <div className="border border-zinc-800 bg-zinc-950">
      ...
      <div className="relative">
        ...
        <div className="pointer-events-none absolute inset-0 flex items-start justify-between px-3 py-1 font-mono text-[10px] text-zinc-600">
